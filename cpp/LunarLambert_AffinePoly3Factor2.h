/**
 * @file LunarLambert_AffinePoly3Factor2.h
 ...
 * associated landmark.
 *
 * This factor leverages the an affine phase weighting function and a 3rd-order
 * polynomial phase correction function.
 *
 * Refs:
 * [1] S. Schröder et al. “Resolved spectrophotometric properties of the Ceres 
 *       surface from Dawn Framing Camera images,” Icarus, 2017. 
 *       https://doi.org/10.1016/j.icarus.2017.01.026
 */
...
class LunarLambert_AffinePoly3Factor2
    : public gtsam::NoiseModelFactorN<gtsam::Unit3,    // sun vector
                                      ...
                                      gtsam::Vector4,  // phase correction terms
 ...
 public:
   ...
   */
  LunarLambert_AffinePoly3Factor2(gtsam::Key sKey, gtsam::Key nKey,
   ...
   * @param c     the phase correction terms in Vector4
   ...
   * @param H7    optional 1x4 Jacobian matrix wrt c
  ...
  gtsam::Vector evaluateError(
      ...
      const double &a, const gtsam::Vector2 &w, const gtsam::Vector4 &c,
    ...
    gtsam::Point3 e = r - l;                    // r_A_CA - r_A_LA = r_A_CL
